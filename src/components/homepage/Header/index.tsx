...
const Header = () => {
  return (
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden bg-cover bg-top bg-no-repeat bg-[url('/images/banner/banner_back.png')]">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-3xl lg:text-[60px] lg:leading-[64px] mb-5 lg:mb-8 text-white/90 ",
            ])}
          >
            BREWS,
            BITES,
          ...
          >
            We are a six-minute weekend, with the best of our
            customers Sweetness.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
          ...
          >
            <Link
              href="/shop"
              className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-secondary hover:bg-primary/80 transition-all text-primary hover:text-secondary px-14 py-4 rounded-full hover:animate-pulse"
            >
              Shop Now
            </Link>
          </motion.div>
          ...
          >
            <div className="flex flex-col">
              <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2 text-white/90">
                <AnimatedCounter from={0} to={200} />+
              </span>
              <span className="text-xs xl:text-base text-white/90 text-nowrap">
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[left_top_-1.6rem] bg-no-repeat bg-[url('/images/banner/coffee_cup.png')] md:bg-[url('/images/banner/coffee_cup.png')]"
        >
          <Image
            priority
